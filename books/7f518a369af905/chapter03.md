---
title: "Microsoft 365 A3の限界と児童生徒個人情報保護の課題"
---

# A3ライセンスでできること・できないことの現実
...
教育機関は、単純なスパムメールやマルウェアだけでなく、**児童生徒の個人情報を狙った高度で持続的な攻撃**の標的となっています。A3ライセンスの基本的な保護機能では、これらの脅威に対して全く無力です。
...
児童生徒の個人情報は、一般的な企業データとは全く異なる特殊性と保護要件を持ちます。成績・出席・生活指導記録・健康情報・家庭環境等の情報は、**本人の人格・尊厳・将来に直結する極めて機微な情報**であり、最高レベルの保護が必要です。
...
教育機関において最も深刻な脅威は、実は**内部の教職員による意図的・非意図的な個人情報の不適切な取扱い**です。外部からの攻撃以上に、内部関係者による情報漏洩は発見が困難で、被害が拡大しやすい特徴があります。
...
児童生徒の個人情報保護を確実に実現するためには、**24時間365日の継続的な監視・分析・対応**が不可欠です。教育機関では専任のセキュリティ要員を配置することが困難なため、AI・機械学習による自動監視・分析が必要ですが、A3ではこれらの機能が全く利用できません。
